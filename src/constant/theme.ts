...
export const darkGreenTheme : any = {
  ...
  background: '#1A5D1A', // Light Grayish
...
export const lightGreenTheme: any = {
  ...
  background: '#EEEeeE',  // Light Grayish
  textColor: '#1A5D1A', // White
  drawerItemText: '#1A5D1A',
  borderColor: '#1A5D1A',
  headerText: '#1A5D1A',
};
...
export const lightRedTheme: any = {
  ...
  textColor: '#B01002', // Dark Gray
  drawerItemText: '#B01002', // Dark Gray
  borderColor: '#B01002', // Dark Gray
  headerText: '#B01002', // Dark Gray
...
export const darkRedTheme: any = {
  ...
  background: '#B01002', // Dark Background
};
...
export const lightBlueTheme: any = {
  ...
  textColor: '#fff', // Dark Gray
  drawerItemText: '#fff', // Dark Gray
  borderColor: '#fff', // Dark Gray
  headerText: '#fff', // Dark Gray
  background: '#3f9fdf', // Light Blueish
};
...
export const lightYellowTheme: any = {
  ...
  secondaryColor: '#FFC107', // Yellow
  accentColor: '#FFD54F', // Amber
  textColor: '#FFA000', // White
  drawerItemText: '#FFA000', // Dark Gray
  borderColor: '#FFA000', // Dark Gray
  headerText: '#FFA000', // Dark Gray
  background: '#EEEeeE', // Dark Background
};
